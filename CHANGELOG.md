...
- MIT license: a LICENSE file and the `license` field in package.json.

### Changed

- README: installation from npm with `pi install npm:pi-clearthen`.
...
- README: clearthen is a standalone extension. The specflo section is now a
  recommendation that explains specflo's auto-continue checkpoints.
